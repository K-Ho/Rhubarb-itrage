...
var ExchangeWrapper = /** @class */ (function (_super) {
    ...
    ExchangeWrapper.prototype.batchFillOrKillAsync = function (orderFillRequests, takerAddress, orderTransactionOpts) {
        return __awaiter(this, void 0, void 0, function () {
            var exchangeContractAddresses, exchangeInstance, shouldValidate, zrxTokenAddress, exchangeTradeEmulator, _i, orderFillRequests_2, orderFillRequest, orderAddressesValuesAndTakerTokenFillAmounts, _a, orderAddresses, orderValues, fillTakerTokenAmounts, vParams, rParams, sParams, gas, txHash;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        assert_1.assert.doesConformToSchema('orderFillRequests', orderFillRequests, json_schemas_1.schemas.orderFillRequestsSchema);
                    ...
                    case 3:
                        ...
                        _b.label = 4;
                    case 4:
                        if (!(_i < orderFillRequests_2.length)) return [3 /*break*/, 7];
