...
export declare class TokenWrapper extends ContractWrapper {
     ...
     */
    setAllowanceAsync(tokenAddress: string, ownerAddress: string, spenderAddress: string, amountInBaseUnits: BigNumber): Promise<string>;
    /**
     ...
     * @return Transaction hash.
     */
    setProxyAllowanceAsync(tokenAddress: string, ownerAddress: string, amountInBaseUnits: BigNumber): Promise<string>;
    /**
     ...
     * @return Transaction hash.
     */
    transferAsync(tokenAddress: string, fromAddress: string, toAddress: string, amountInBaseUnits: BigNumber): Promise<string>;
    /**
     * Transfers `amountInBaseUnits` ERC20 tokens from `fromAddress` to `toAddress`.
     ...
     * @return Transaction hash.
     */
    transferFromAsync(tokenAddress: string, fromAddress: string, toAddress: string, senderAddress: string, amountInBaseUnits: BigNumber): Promise<string>;
    /**
