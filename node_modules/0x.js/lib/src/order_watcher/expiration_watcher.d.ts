...
export declare class ExpirationWatcher {
    private orderHashByExpirationRBTree;
    private expiration;
    private orderExpirationCheckingIntervalMs;
    private expirationMarginMs;
    private orderExpirationCheckingIntervalIdIfExists?;
    constructor(expirationMarginIfExistsMs?: number, orderExpirationCheckingIntervalIfExistsMs?: number);
    subscribe(callbackAsync: (orderHash: string) => Promise<void>): void;
    unsubscribe(): void;
    addOrder(orderHash: string, expirationUnixTimestampMs: BigNumber): void;
    removeOrder(orderHash: string): void;
    private pruneExpiredOrdersAsync(callbackAsync);
}
