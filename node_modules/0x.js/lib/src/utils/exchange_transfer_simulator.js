...
var ExchangeTransferSimulator = /** @class */ (function () {
    function ExchangeTransferSimulator(token) {
        this.store = new balance_proxy_allowance_lazy_store_1.BalanceAndProxyAllowanceLazyStore(token);
    ...
    ExchangeTransferSimulator.prototype.throwValidationError = function (failureReason, tradeSide, transferType) {
