...
var OrderStateUtils = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 8:
                        ...
                        fillableMakerTokenAmount = bignumber_js_1.default.min([makerProxyAllowance, makerBalance]);
                        remainingFillableMakerTokenAmount = bignumber_js_1.default.min(fillableMakerTokenAmount, remainingMakerTokenAmount);
                        remainingFillableTakerTokenAmount = remainingFillableMakerTokenAmount
    ...
    OrderStateUtils.prototype.validateIfOrderIsValid = function (signedOrder, orderRelevantState) {
