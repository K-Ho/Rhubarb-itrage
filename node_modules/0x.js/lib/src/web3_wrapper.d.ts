...
import { Artifact, TransactionReceipt } from './types';
export declare class Web3Wrapper {
    ...
    private sendRawPayloadAsync<A>(payload);
    private normalizeTxReceiptStatus(status);
    private formatLog(rawLog);
    private hexToDecimal(hex);
}
