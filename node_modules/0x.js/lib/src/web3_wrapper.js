...
var Web3Wrapper = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        balanceInWei = new bignumber_js_1.default(balanceInWei);
    ...
    Web3Wrapper.prototype.getBlockNumberAsync = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, promisify(this.web3.eth.getBlockNumber)()];
                    case 1:
                        blockNumber = _a.sent();
    ...
    Web3Wrapper.prototype.getBlockAsync = function (blockParam) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, promisify(this.web3.eth.getBlock)(blockParam)];
                    case 1:
                        block = _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        rawLogs = _a.sent();
                        formattedLogs = _.map(rawLogs, this.formatLog.bind(this));
    ...
    Web3Wrapper.prototype.sendRawPayloadAsync = function (payload) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        sendAsync = this.web3.currentProvider.sendAsync.bind(this.web3.currentProvider);
                        return [4 /*yield*/, promisify(sendAsync)(payload)];
                    case 1:
                        response = _a.sent();
    ...
    Web3Wrapper.prototype.normalizeTxReceiptStatus = function (status) {
        ...
        if (_.isString(status)) {
            return this.web3.toDecimal(status);
        }
    ...
    Web3Wrapper.prototype.formatLog = function (rawLog) {
        var formattedLog = __assign({}, rawLog, { logIndex: this.hexToDecimal(rawLog.logIndex), blockNumber: this.hexToDecimal(rawLog.blockNumber), transactionIndex: this.hexToDecimal(rawLog.transactionIndex) });
        return formattedLog;
    };
    Web3Wrapper.prototype.hexToDecimal = function (hex) {
        if (_.isNull(hex)) {
            return null;
        }
        var decimal = this.web3.toDecimal(hex);
        return decimal;
    };
    return Web3Wrapper;
}());
