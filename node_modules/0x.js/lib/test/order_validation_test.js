        ...
        it('should correctly round the fillMakerTokenAmount', function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        signedOrder = _a.sent();
                        return [4 /*yield*/, orderValidationUtils.validateFillOrderBalancesAllowancesThrowIfInvalidAsync(exchangeTransferSimulator, signedOrder, takerTokenAmount, takerAddress, zrxTokenAddress)];
                    case 2:
                        _a.sent();
                        expect(transferFromAsync.callCount).to.be.equal(4);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, orderValidationUtils.validateFillOrderBalancesAllowancesThrowIfInvalidAsync(exchangeTransferSimulator, signedOrder, fillTakerTokenAmount, takerAddress, zrxTokenAddress)];
                    case 2:
                        _a.sent();
